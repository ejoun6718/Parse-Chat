...
1. How to create a sign out button
2. How to add an emoji list

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/6tBbXfg.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
The most difficult part was figuring out how to store and retrieve data using Query
Parse, especially for the username. 
